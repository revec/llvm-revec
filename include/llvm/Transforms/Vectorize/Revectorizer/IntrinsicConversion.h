...
static void initializeIntrinsicWideningMap() {
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmadd_ub_sw, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_pmaddubs_w_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmadd_wd, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_pmaddw_d_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmovmskb, std::vector<WideningTarget>({
        { 1, Intrinsic::x86_sse2_pmovmskb_128}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmul_hr_sw, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_pmul_hr_sw_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmulh_w, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_pmulh_w_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_pmulhu_w, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_pmulhu_w_512}}));
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx2_psra_w, std::vector<WideningTarget>({
        { 1, Intrinsic::x86_avx512_psrav_w_256}, 
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prolv_d_128, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prolv_d_256}, 
        { 4, Intrinsic::x86_avx512_prolv_d_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prolv_d_256, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prolv_d_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prolv_q_128, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prolv_q_256}, 
        { 4, Intrinsic::x86_avx512_prolv_q_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prolv_q_256, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prolv_q_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prorv_d_128, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prorv_d_256}, 
        { 4, Intrinsic::x86_avx512_prorv_d_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prorv_d_256, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prorv_d_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prorv_q_128, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prorv_q_256}, 
        { 4, Intrinsic::x86_avx512_prorv_q_512}}));
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx512_prorv_q_256, std::vector<WideningTarget>({
        { 2, Intrinsic::x86_avx512_prorv_q_512}}));
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_avx_movmsk_pd_256, std::vector<WideningTarget>({
        { 1, Intrinsic::x86_sse2_movmsk_pd}}));
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_sse2_movmsk_pd, std::vector<WideningTarget>({
        { 1, Intrinsic::x86_avx_movmsk_pd_256}}));
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_sse2_pmulhu_w, std::vector<WideningTarget>({
        ...
        { 4, Intrinsic::x86_avx512_pmulhu_w_512}}));
    ...
    intrinsicWideningMap.try_emplace(Intrinsic::x86_sse_movmsk_ps, std::vector<WideningTarget>({
        { 1, Intrinsic::x86_avx_movmsk_ps_256}}));
