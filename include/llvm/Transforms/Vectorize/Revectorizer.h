...
#ifndef LLVM_TRANSFORMS_VECTORIZE_REVECTORIZER_H
#define LLVM_TRANSFORMS_VECTORIZE_REVECTORIZER_H
...
private:
  ...
  bool tryToVectorizeList(ArrayRef<Value *> VL, revectorizer::BoUpSLP &R,
  ...
  bool vectorizeCmpInst(CmpInst *CI, BasicBlock *BB, revectorizer::BoUpSLP &R);
  ...
  bool vectorizeSimpleInstructions(SmallVectorImpl<WeakVH> &Instructions,
                                   BasicBlock *BB, revectorizer::BoUpSLP &R);
  ...
  bool vectorizeStores(ArrayRef<StoreInst *> Stores, revectorizer::BoUpSLP &R);
